...
$title = '編輯商品主分類內容';
$pageName = 'edit_main-category';

$id = isset($_GET['id']) ? intval($_GET['id']) : 0;
if (empty($id)) {
    header('Location: 31.main-category_list.php');
    exit;
}

$sql = "SELECT * FROM categories_main WHERE id=$id";
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">編輯商品主分類內容</h5>
                        <form name="form1" onsubmit="sendData(event)"> <!-- 因為有下onsubmit，故action和methon就沒有用處了，可以刪除 -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="main" name="main" value="<?= htmlentities($r['main']) ?>">
                                <div class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                <label for="carbon_points_available" class="form-label">*可獲得小碳點數</label>
                                <input type="text" class="form-control" id="carbon_points_available" name="carbon_points_available" value="<?= $r['carbon_points_available'] ?>">
                                <div class="form-text"></div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button href="31.main-category_list.php" class="btn btn-primary" onclick="backToList()">回到列表頁</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function backToList() {
        if (document.referrer) {
            ...
            location.href = '31.main-category_list.php';
        }
    ...
    function sendData(e) {
        ...
        if (mainEl.value.length < 1 && !validateTitle(main)) {
            isPass = false; // 沒有通過檢查
        ...
        if (isPass) {
            ...
            fetch(`37.main-category_edit-api.php`, {
                method: 'POST',
                body: fd,
