                        ...
                        <form name="form1" onsubmit="sendData(event)"> <!-- 因為有下onsubmit，故action和methon就沒有用處了，可以刪除 -->
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="main" name="main">
                                    ...
                                    <?php foreach ($rows2 as $r2) : ?>
                                        <option value="<?= $r['main_category'] ?>" <?= $r['main_category'] == $r2['id'] ? 'selected' : '' ?>><?= $r2['main'] ?></option>
                                    <?php endforeach ?>
                                </select>
                                <div class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="sub" name="sub">
                                    <?php foreach ($rows as $r1) : ?>
                                        <?php foreach ($rows2 as $r2) : ?>
                                            <?php if ($r['main_category'] == $r2['id']) : ?>
                                                <option value="<?= $r['sub_category'] ?>" <?= $r['sub_category'] == $r1['sub'] ? 'selected' : '' ?>><?= $r1['sub'] ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="card-container2">
                                    <label for="img" class="form-label">已上傳圖片</label>
                                    <img src="./02.imgs/<?= $r['product_photos'] ?>" alt="">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="carbonPoints" name="carbonPoints">
                                    <?php foreach ($rows2 as $r2) : ?>
                                        <?php if ($r['main_category'] == $r2['id']) : ?>
                                            <option value="<?= $r['carbon_points_available'] ?>" <?= $r['carbon_points_available'] == $r2['carbon_points_available'] ? 'selected' : '' ?>><?= $r['carbon_points_available'] ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                                <div class="form-text"></div>
