            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <?php if (isset($_SESSION['admin'])) : ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $pageName == 'order-normal_list' ? 'active' : '' ?>" href="41.order-normal_list.php">一般訂單列表</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $pageName == 'add_sub-category' ? 'active' : '' ?>" href="42.order-normal_add.php">新增</a>
                        </li>
                    <?php else : ?>
                        <li class="nav-item">
