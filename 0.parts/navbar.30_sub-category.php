...
<?php if ($pageName == 'add_sub-category' || $pageName == 'edit_sub-category') : ?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <?php if (isset($_SESSION['admin'])) : ?>
              ...
              <li class="nav-item">
                <a class="nav-link color-strong" href="32.sub-category_list.php">商品子分類列表</a>
              </li>
            <?php else : ?>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link <?= $pageName == 'product_list' ? 'active' : '' ?>" href="32.sub-category_list.php">商品子分類列表</a>
              </li>
            <?php endif; ?>
          </ul>
    ...
    <div class="card text-center mt-3">
      ...
      <div class="mt-1 d-flex justify-content-start mb-1">
        <div class="input-group-sm d-flex ms-2 me-2">
          <input id="searchInput" type="text" class="rounded-start ps-1" placeholder="搜尋子分類關鍵字">
