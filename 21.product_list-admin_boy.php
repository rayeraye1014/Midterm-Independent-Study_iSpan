...
#算總筆數
$t_sql = "SELECT count(1) FROM products JOIN categories_main ON products.main_category = categories_main.id WHERE main = '男裝服飾'";
