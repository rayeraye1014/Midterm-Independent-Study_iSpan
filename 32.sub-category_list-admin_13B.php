...
if ($totalRows) {
    ...
    $sql = sprintf("SELECT * FROM categories_main join categories_sub on categories_sub.main_category = categories_main.id  WHERE main = '嬰兒孩童' ORDER BY categories_sub.id LIMIT %s, %s", ($page - 1) * $perPage, $perPage);
